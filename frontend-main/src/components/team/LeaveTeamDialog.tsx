    ...
    <>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent>
          ...
          <DialogDescription>
            Once you leave you will need to join the team again. Are you sure
            you want to leave <span className="font-semibold">{team.name}</span>
            ?
          </DialogDescription>
          {error && (
